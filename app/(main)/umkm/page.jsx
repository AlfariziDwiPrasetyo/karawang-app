        ...
        <div className="mt-5 md:pr-20 md:mr-10">
          ...
          <div className="overflow-x-auto mt-5">
            ...
            <p className="text-justify pt-5">
              ...
              warga banyak yang mempunyai mata pencaharian dengan berdagang,
              usaha berdagang berupa pertokoan yang besar sampai pedagang kaki
              lima, dan ada juga usaha lainya berupa perbengkelan kendaraan
              otomotif sampai pembuatan aksesoris serta usaha lainya karena
              letak kelurahan Nagasari yang merupakan daerah perkotaan, sehingga
              perekonomian dilingkungan Kelurahan Nagasari cukup menjanjikan
              dimana usaha perdaganan dan jasa banyak yang berhasil.
            </p>
          </div>
        </div>
      </div>
